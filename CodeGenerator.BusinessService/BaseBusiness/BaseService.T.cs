...
namespace CodeGenerator.BusinessService
{
    ...
    public class BaseService<T> : IBaseService<T> where T : class, new()
    {
        ...
        public BaseService(string conStr, DatabaseType dbType)
        {
        ...
        public BaseService(string conStr, DatabaseType dbType, string entityNamespace)
        {
        ...
        /// <param name="dbType">数据库类型</param>
        public BaseService(DbContext dbContext, DatabaseType dbType)
        {
        ...
        /// <typeparam name="T">实体类型</typeparam>
        /// <param name="entities">数据列表</param>
        public int Modify(List<T> entities)
        {
            return Service.Modify(entities);
        }
        ...
        public int Modify(T entity, List<string> properties)
        {
            return Service.Modify(entity, properties);
        }
        ...
        {
            return Service.Modify(entity, proNames);
        }
        ...
        /// <param name="entity">实体对象</param>
        /// <param name="properties">需要更新的字段</param>
        public int Modify(List<T> entities, params string[] proNames)
        {
            return Service.Modify(entities, proNames);
        }
        ...
        /// <param name="entities">数据列表</param>
        /// <param name="properties">需要更新的字段</param>
        public int Modify(List<T> entities, List<string> properties)
        {
            return Service.Modify(entities, properties);
        }
        ...
        public int Modify(Expression<Func<T, bool>> whereExpre, Action<T> set)
        {
            return Service.Modify(whereExpre, set);
        }
        ...
        public List<T> BuildSelectResult(string selectedValueJson, string q, string textFiled, string valueField)
        {
            ...
            var iq = new BaseService<T>().GetIQueryable();
            string where = " 1=1 ";
