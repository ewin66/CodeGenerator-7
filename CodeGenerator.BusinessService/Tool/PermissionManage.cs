...
namespace CodeGenerator.BusinessService.Tool
{
    /// <summary>
    /// 权限管理静态类
    /// </summary>
    public static class PermissionManage
    {
        ...
        {
            BaseService<Base_PermissionRole> _db = new BaseService<Base_PermissionRole>();
        ...
        public static List<string> GetAppIdPermissionValues(string appId)
        {
            ...
            if (permissions == null)
            {
                BaseService<Base_PermissionAppId> _db = new BaseService<Base_PermissionAppId>();
        ...
        public static void SetAppIdPermission(string appId, List<string> permissions)
        {
            ...
            //更新数据库
            BaseService<Base_UnitTest> _db = new BaseService<Base_UnitTest>();
        ...
        public static void UpdateUserPermissionCache(string userId)
        {
            ...
            BaseService<Base_PermissionUser> _db = new BaseService<Base_PermissionUser>();
            ...
            var roleIdList = Base_UserService.GetUserRoleIds(userId);
