...
namespace CodeGenerator.DataRepository
{
    public class BaseDbContext:DbContext
    {
        ...
        //[Obsolete] //调试状态下控制台输出栏打印执行Sql语句
        //public static readonly LoggerFactory _loger = new LoggerFactory(new[] { new DebugLoggerProvider((_, __) => true) });

        /// <summary>
        /// 数据库上下文构造函数
        /// </summary>
        /// <param name="nameOrConstr">数据库链接名或连接字符串</param>
        ...
        public BaseDbContext(string nameOrConStr, DatabaseType dbType,string entityNamespace){
            ...
            _dbType = dbType;
            _entityNamespace = entityNamespace.IsNullOrEmpty() ? "CodeGenerator.Entity" : entityNamespace;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            List<Type> types = Assembly.Load("CodeGenerator.Entity").GetTypes()
