...
namespace CodeGenerator.Util
{
    ...
    public class GlobalSwitch
    {
        ...
        /// 项目名
        /// </summary>
        public static string ProjectName { get; } = "CodeGenerator";
        ...
        /// 默认实体命名空间
        /// </summary>
        public static string DefaultEntityNamespace { get; } = "CodeGenerator.Entity";
        #endregion
        ...
        /// 默认缓存
        /// </summary>
        public static CacheType CacheType { get; } = CacheType.RedisCache;
